// Module2-Lesson3-Challenge

// Precondition step
// 1. npx create-react-app solana-challenge3-phantom --template typescript
// 2. cd solana-challenge3-phantom
// 3. yarn add @solana/web3.js
...
function App() {
  ...
  const disconnectWallet = async () => {
    // Seemingly, disconnect works without uncomment code below
  ...
  return (
    <div className="App">
      ...
      {provider && !walletKey && (
        ...
        {provider && walletKey && <p>Connected account <div>address is "<>{walletKey}</>"</div></p>}
        {provider && walletKey && <button className='App-disconnect' onClick={disconnectWallet}>Disconnect</button>}
